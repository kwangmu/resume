  ...
  return (
    <section id={id} className="min-h-[80vh] md:min-h-[90vh] flex flex-col justify-center scroll-mt-20">
      <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-2xl md:rounded-3xl shadow-2xl overflow-visible md:overflow-hidden border border-amber-500/20 relative">
        ...
        <div className="relative bg-gradient-to-r from-amber-600/20 via-amber-500/10 to-blue-600/20 h-60 md:h-32 lg:h-56 pb-[7.5rem] md:pb-0">
          ...
          <div className="absolute bottom-4 md:-bottom-[31.2px] left-1/2 md:left-8 lg:left-12 -translate-x-1/2 md:translate-x-0 flex flex-col md:flex-row items-center gap-4 md:gap-4">
        ...
        <div className="relative pt-12 md:pt-24 px-4 md:px-8 lg:px-12 pb-8 md:pb-12">

...
export const ExperienceSection: React.FC<SectionProps> = ({ id }) => {
  return (
    <section id={id} className="scroll-mt-24">
      ...
      <div className="space-y-6 md:space-y-12 relative md:before:absolute md:before:inset-0 md:before:left-1/2 md:before:-translate-x-1/2 md:before:h-full md:before:w-0.5 md:before:bg-gradient-to-b md:before:from-amber-500/20 md:before:via-amber-500/50 md:before:to-amber-500/20 md:before:z-0">
        
        {/* Card 1 - Left */}
        <div className="relative flex flex-col md:flex-row md:items-center group z-10">
        ...
        {/* Card 2 - Right */}
        <div className="relative flex flex-col md:flex-row md:items-center md:justify-end group z-10">
